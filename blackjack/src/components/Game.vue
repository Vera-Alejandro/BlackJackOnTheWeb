    ...
    <div class="p-5">
      <div class="flex flex-col">
        <div class="flex flex-row p-5 justify-between">
            <div class="pr-5">
                <img src="https://alejandropersonalstorage.blob.core.windows.net/public-images/BackJack-Title.png" alt="logo">
            </div>
            <div class="px-16">
        ...
        <div class="grid grid-cols-2 gap-4 p-5">
            <div v-for="cardImg in dealerCards" :key="cardImg.id" class="relative h-96 bg-white ">
              <img class="absolute left-0 top-2" :src="cardImg.src" alt="card back">
            </div>
            <div class="h-96 bg-white relative">
              <img class="absolute left-0 top-8" src="https://alejandropersonalstorage.blob.core.windows.net/public-images/Ace-of-Diamonds.png" alt="card back">
              <img class="absolute left-10 top-8" src="https://alejandropersonalstorage.blob.core.windows.net/public-images/Ace-of-Diamonds.png" alt="card back">
            </div>
        </div>
